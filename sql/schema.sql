...
create table admin_settings (
  ...
  estimator_llm_provider text not null default 'OPENAI',
  estimator_llm_model text,
  visualization_llm_provider text not null default 'OPENAI',
  visualization_llm_model text,
  visualization_image_model text,
  smtp_host text,
  smtp_port int,
  smtp_user text,
  smtp_pass text,
