    ...
    <>
      ...
      {mounted &&
        createPortal(
          ...
          >
            <div
              className="absolute inset-0 bg-[#334155]/25 backdrop-blur-sm transition-opacity duration-200"
            ...
            <div
              ...
              className="absolute top-0 right-0 bottom-0 w-full max-w-[min(320px,85vw)] bg-[#ffffff] border-l border-[#e6ebf1] shadow-2xl flex flex-col transition-transform duration-300 ease-out"
              style={{ transform: open ? "translateX(0)" : "translateX(100%)" }}
            >
              <div className="flex items-center justify-between p-4 border-b border-[#e6ebf1]">
                <span className="text-sm font-semibold text-[#334155]">Menu</span>
                <button
                  type="button"
                  onClick={close}
                  className="flex h-10 w-10 items-center justify-center rounded-xl text-[#6b7280] hover:bg-[#f8fafc] hover:text-[#334155] transition-colors"
              ...
              <nav className="flex-1 overflow-y-auto p-4 flex flex-col gap-1 min-h-0">
                ...
                {user ? (
                  <form action={logoutAction} className="block">
                      ...
                      >
                        <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-[#f8fafc] text-[#6b7280]">
                  ...
                  <>
                    ...
                    <Link
                      ...
                      onClick={close}
                      className="flex items-center gap-3 rounded-xl px-4 py-3 bg-[#F59E0B] text-white hover:opacity-95 transition-opacity"
                    >
